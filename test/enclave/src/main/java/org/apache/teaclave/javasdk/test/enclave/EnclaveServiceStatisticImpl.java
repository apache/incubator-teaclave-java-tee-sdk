...
public class EnclaveServiceStatisticImpl implements EnclaveServiceStatistic {
    ...
    public int getEnclaveServiceCount() throws Exception {
        Method getInstance = Class.forName("org.apache.teaclave.javasdk.enclave.framework.EnclaveContext").getMethod("getInstance");
        getInstance.setAccessible(true);
        Method servicesSize = Class.forName("org.apache.teaclave.javasdk.enclave.framework.EnclaveContext").getMethod("servicesSize");
